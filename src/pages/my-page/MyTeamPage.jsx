      ...
      {filtered.map((team) => {
        ...
        return (
          <section key={team.id} css={styles.teamCard}>
            <button css={styles.teamHeader} onClick={() => toggle(team.id)} aria-expanded={isOpen}>
              <div>
            ...
            {isOpen &&
              team.members.map((member) => (
                <div key={member.id} css={styles.memberRow(isProject)}>
                  ...
                  {isProject && (
                    <small css={[styles.subText, { textAlign: 'center' }]}>{member.position}</small>
                  )}
          ...
          <div css={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <ul css={styles.notes}>
              ...
              <li>
                ...
                명예훼손, 욕설, 타인비방글 등 제 3자의 권리를 침해하는 피드백은 서비스 이용약관이나
